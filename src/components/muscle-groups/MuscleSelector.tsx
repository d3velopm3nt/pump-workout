...
export const MuscleSelector: React.FC<MuscleSelectorProps> = ({
  ...
  return (
    <div className="space-y-6 border p-4 rounded-lg bg-white">
      <div>
        <Label className="text-base font-semibold mb-2 block">Muscle Groups & Muscles</Label>
        ...
        <div className="mt-4 space-y-2 border p-3 rounded-md bg-gray-50">
          {muscleGroups
      ...
      {selectedMuscles.length > 0 && (
        <div className="mt-6">
          <Label className="text-base font-semibold mb-2 block">Selected Muscles</Label>
          <div className="border rounded-lg overflow-hidden bg-white">
            <table className="w-full">
              <thead>
                <tr className="bg-gray-50 border-b">
                  <th className="px-4 py-2 text-left font-medium text-gray-700">Muscle</th>
                  <th className="px-4 py-2 text-left font-medium text-gray-700">Effectiveness</th>
                </tr>
              </thead>
              <tbody>
